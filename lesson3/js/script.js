...
document.querySelector("#Year").innerHTML = date.getFullYear();
 ...
 function change() {
  ...
  function log() {
    setTimeout(console.log.bind(console, "%c Quentin Naef %c", "background-color: #bdd4e7;background-image: linear-gradient(315deg, #bdd4e7 0%, #8693ab 74%);padding:5px;border-radius: 5px;line-height: 26px;", ""));
